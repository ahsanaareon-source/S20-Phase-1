    ...
    return (
      <div>
        ...
        <div className="mt-3">
          ...
          >
            <span>• Cladding Major Works Dockside<br /><span className="text-muted" style={{ fontSize: '11px' }}>Delayed, missing tender submissions</span></span>
        ...
        <div className="mt-3">
          ...
          >
            <span>• RSF Major Works Legacy House<br /><span className="text-muted" style={{ fontSize: '11px' }}>Consultation period ending soon</span></span>
            <ExternalLink size={14} />
          </button>
